...
class CommandItem(ExternalItem):
    ...
    def __init__(self, color, text, command, arguments=None, menu=None, should_exit=False):
        """
        ...
        """
        super(CommandItem, self).__init__(color=color, text=text, menu=menu, should_exit=should_exit)
