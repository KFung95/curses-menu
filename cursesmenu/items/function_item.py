...
class FunctionItem(ExternalItem):
    ...
    def __init__(self, color, text, function, args=None, kwargs=None, menu=None, should_exit=False):
        """
        ...
        """
        super(FunctionItem, self).__init__(color=color, text=text, menu=menu, should_exit=should_exit)
